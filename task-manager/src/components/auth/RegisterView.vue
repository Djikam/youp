<template>
  <div class="py-1">
      ...
      <body class="h-screen overflow-hidden w-full flex items-center justify-center " style="background: #edf2f7;">
          <div class="relative min-h-screen w-full flex ">
              <div
                  ...
                  <div class="sm:w-1/2 xl:w-3/5 h-full hidden md:flex flex-auto items-center justify-center p-10 overflow-hidden bg-purple-900 text-white bg-no-repeat bg-cover bg-center relative"
                      ...
                      <div class="w-full  max-w-md z-10">
                          <div class="sm:text-4xl xl:text-5xl font-bold leading-tight mb-6">Vos prochaines Task A votre portee
                          </div>
                  ...
                  <div
                      ...
                      <div class="max-w-md w-full space-y-8">
                          <div class="text-center">
                              ...
                              <p class="mt-2 text-sm text-gray-500">S'il vous plait enregistrez vous</p>
                          </div>
                          <div class="flex items-center justify-center space-x-2">
                              <span class="h-px w-16 bg-gray-200"></span>
                              <span class="text-gray-300 font-normal">'senregistrer'</span>
                              <span class="h-px w-16 bg-gray-200"></span>
                          </div>
    ...
    <div class="relative">
      ...
      <label class="ml-3 text-sm font-bold text-gray-700 tracking-wide">Noms</label>
      <input v-model="form.name"
          class=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500"
          type="text" placeholder="jena haylou">
    </div>
    ...
    <p class="flex flex-col items-center justify-center mt-10 text-center text-md text-gray-500">
      ...
      <router-link to="/connexion"
          class="text-indigo-400 hover:text-blue-500 no-underline hover:underline cursor-pointer transition ease-in duration-300">Se connecter
      </router-link>
    </p>
  </form>
                      </div>
